...
export default function Dates() {
  ...
  <Text style = {{textAlign:"center", fontSize:23, margin:20}}> WHICH DAY IN THE WEEK DO YOU WANT TO DO         EXERCISE?</Text>
   <Text>(please click all the day you would love to join)</Text>
   <View style= {{flexDirection:"row", justifyContent: "center", alignItems:"center" ,backgroundColor:   'white',marginTop:10}}>
